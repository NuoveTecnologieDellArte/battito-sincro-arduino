...
int ledPin = 0;
int m = 4; //serve per la luminosità massima (diminuisci con 2/3/1 oppure usa float per i numeri decimali)
...
void pulsa() {
  ...
  delay(100);
  Serial.print("inizio pulsazione");
  for (int i = 0; i < 255; i++) {
